...
INSTRUCTION = {
    "classification": ("Classify the given sentence into one of the following categories based on its toxicity level: A. Not toxic, B. Slightly toxic, C. Moderately toxic, or D. Highly toxic. Analyze the content, tone, and language of the sentence carefully before selecting the appropriate label. Return only the label as the output. ")
